 ...
 <script type="text/javascript">
	...
	function clickt(){
		...
		$.ajax({
            ...
            $.ajax({
			url:"https://5d1b152edd81710014e8825d.mockapi.io/fixnix/whistle/1/investigator/"+tipNo,
			/*url:"https://5d1b152edd81710014e8825d.mockapi.io/fixnix/whistle/"+tipNo,*/
			method:"GET",
			type:"json",
			success:function(data){
            ...
            $.ajax({
			url:"https://5d1b152edd81710014e8825d.mockapi.io/fixnix/whistle/1/investigator/1/reviewer/"+tipNo,
			method:"GET",
			type:"json",
			success:function(data){
                ...
                $("#reinvestigation").text(data.reinvestigation) 
				$("#encryptedSecret").text(data.encryptedSecret)
	...
	function messagesent(){
		...
		var time = new Date()
		var text = "Reviewer-"+message+"-"+time
			   ...
			   <div class="form-group">
			      ...
			      <br><br>						
			              ...
			              <div class="col-md-3 col-xs-1">
			                <input type="text" placeholder="$" class="form-control" style="border-color: #216582; margin-left: 37px;">
...
<!-- 
     ...
     <br><br>
                  ...
                  <!--  <div class="form-group">
			               <div class="col-xs-8">
			               <input type="text" name="aware" value="peo1" checked="checked" id="resolution" style="margin-left: 140px;"><b>Resolution </b>&nbsp;&nbsp;&nbsp;
			               <input type="text" name="aware" value="peo2" id="reinvestigation" style="margin-left: 240px;"><b>Re-Investigate</b>
                ...
                <div id="peop1" class="container">   
                  <textarea type="text" id="resolution" placeholder="Resolution" class="form-control" style="height: 150px;border-color: #216582;width: 975px; margin-left: 140px;"></textarea>  
      </div>
			       ...
			       <div style="margin-left: 640px;" >OR</div>
                <label style="font-size: 15px;" class="col-xs-1">Re-Investigate </label>
               <div id="peop2" class="container"> 
			          <textarea type="text" id="reinvestigation" placeholder="Re-Investigate" class="form-control"  style="height: 150px;border-color: #216582;width: 975px; margin-left: 140px; margin-top: 10px;"></textarea>
			    </div>
...
function UpdateButton(){
  ...
  var blowdatas = {
    ...
    reinvestigation :$("#reinvestigation").val(),
  }
  $.ajax({
    type:"POST",
    url: "https://5d1b152edd81710014e8825d.mockapi.io/fixnix/whistle/1/investigator/1/reviewer",
    data : blowdatas,
