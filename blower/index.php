...
<div style="margin-left: 120px;">
  ...
  <div class="container" style="margin-top: 100px; margin-left: 230px;">
    ...
    <div class="form-group">
      ...
      <div class="col-xs-8">
        <select class="form-control" name="companyName" style="border-color: #216582;"onchange='CheckColors(this.value);'>
        ...
        &nbsp; &nbsp; &nbsp;<input type="radio" name="radio3" value="donate">Donate 
                     ...
                     <!--In Case of reward -->
                       ...
                       <div id="peoples" class="container" style="margin-left: 16%;">
                                           <div class="col-md-3 input_val">
                                        <input type="text" placeholder="Non-Profit Name" class="form-control" style="border-color: #216582;">
                                      </div>
                                  <div class="col-md-3 input_val">
                                     <input type="text" placeholder="Bank Name" class="form-control" style="border-color: #216582;">
                                  </div>
                                   <div class="col-md-2 input_val" style="width: 21%;">
                                      <input type="text" placeholder="Bank Account no." class="form-control" style="border-color: #216582;">
                                  </div>
                      </div>
                       ...
                       <div id="donates" class="container"style="margin-left: 16%;">
                         <div class="col-md-3 input_val">
                                ...
                                <img src="BTC1.png" height="40px" width="40px">
                                 <div class="col-md-8 input_val">
                                        <input type="text" placeholder="BitCoin Address" id="Reward" class="form-control" style="border-color: #216582;">OR
                                      </div><br><br>
                                  <img src="ETC.png" height="40px" width="40px"> 
                                      <div class="col-md-8 input_val">
                                        <input type="text" placeholder="Ethereum Address" id="Reward" class="form-control" style="border-color: #216582;">
                                      </div>
                                  <!-- <div class="col-md-3 input_val">
