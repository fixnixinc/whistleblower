			   ...
			   <div class="form-group">
				   <label style="font-size: 15px;" class="col-xs-1">Management Update </label>
					...
					<br/><br/><br/><br/><br/>
					 ...
					 <div class="col-md-8" style="width: 72%;height: 50px;">
					 <span id="resolution" class="form-control" style="font-size: 13px;height: 150px;width: 975px;margin-left: 37px;"></span>
					 ...
					 <div class="col-md-8" style="width: 72%;height: 50px;">
					<span id="reinvestigation" class="form-control" style="font-size: 13px;height: 150px;width: 975px; margin-left: 37px;"></span>
			         </div>
...
<script>
  ...
  $.ajax({
    type:"POST",
    url: "https://5d1b152edd81710014e8825d.mockapi.io/fixnix/whistle/1/investigator",
    data : blowdata,
